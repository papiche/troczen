...
print_info "Étape 1: Configuration de l'environnement"
...
print_info "Étape 2: Installation du service systemd"
...
print_info "Étape 3: Activation du service au démarrage"
sudo systemctl enable "$SERVICE_NAME"
print_success "Service activé au démarrage"

# Étape 4: Afficher les informations de configuration
echo ""
echo "=========================================="
