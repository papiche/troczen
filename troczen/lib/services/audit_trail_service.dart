...
///
/// ✅ SÉPARÉ du cache réseau (CacheDatabaseService) pour:
/// - Conformité RGPD: suppression sélective des données personnelles
/// - Indépendance du cycle de vie: l'audit persiste, le cache peut être vidé
/// - Sécurité: données d'audit isolées des données éphémères
class AuditTrailService {
  ...
  /// ⚠️ Ne supprime QUE le journal d'audit, PAS le cache réseau
